...
* tag wrap everything inside a HTML document. It is composed of one head tag and one body tag.
...
* The following tags represent the distinguish parts of the webpages. \* `<article>, <aside>, <footer>, <header>, or <nav>`
* `<summary>` tag defines a visible heading inside the  element. The heading can be clicked to view/hide the details. `<detail><summary></summary></detail>`
* `<main>` the container for the pages core content. There must not be more than one \* The  element must NOT be a descendant of an `<article><aside><footer><header><nav>` element.
