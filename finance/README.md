...
- Assumptions & Principles
  ...
  - Stable monetary unit assumption - Dollar’s purchasing power is stable over time, same currency
...
- It has three components:
  ...
  - Or `Assets` on the left side, `Owner's Equity - Liabilities` on the right side
...
- Asset must have a certain future benefit, company must have rights to access the future benefits, and they should be quantifiable
