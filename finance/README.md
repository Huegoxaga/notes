...
- Debt securities and equity securites market are negatively correlated, so investing in a combination of bonds and stocks is popular, and the portfolio can be described as the following allocation models when only considering invest in bonds and stocks:
