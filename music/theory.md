...
* From the frequency perspective: `A4` has `440Hz`\(variation applies\)
  ...
  * In general: !\[octave formula\]\([https://render.githubusercontent.com/render/math?math=$f = f\_0 \times 2^{\(\frac{n}{12}%29}$](https://render.githubusercontent.com/render/math?math=$f%20=%20f_0%20\times%202^{%28\frac{n}{12}%29}$)\)
...
* Grand staff
  ...
  * ![grand staff](../.gitbook/assets/grand_staff.png)
...
* Time Signature ![Time signature](../.gitbook/assets/time_signature.png)
...
* See the charts for all notes and rests
  * ![Notes and Rests](../.gitbook/assets/notes.jpg)
...
* The C major tetrachord is on the top of the circle, it goes to the higher major tetrachord in clockwise direction.
  * ![Circle of Fifths](../.gitbook/assets/circle_of_fifths.png)
