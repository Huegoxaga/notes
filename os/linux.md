...
* `g++ -c filename.cpp` is used to only compile and assemble the file\_name and not link the object code to produce executable file, it will generate a `filename.o` object code file in present working directory
