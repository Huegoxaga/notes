...
* For System table of the SQL Server
  * Starting with SQL Server 2005, all System Tables are hidden and inaccessible directly A large collection of System Views have been created to accommodate accessing of database’s metadata Two schemas INFORMATION\_SCHEMA sys
...
* `dbms_job` package allows the scheduling of execution of PL/SQL procedures
  * `dbms_job.submit()`, Enters a PL/SQL procedure as a job into the job queue
    ...
    \(course\_name IN course.description%TYPE\)
